...
public class TextureLoader {
    ...
    { 
        ...
        if (url == null) {
        	...
        	// If no texture could be found, we use a default one        	
        	url = TextureLoader.class.getClassLoader().getResource("textures/notexture.png");
        	
        	if (url == null) {
        		throw new IOException("Cannot find: "+ref);        		
        	}
        	
            BufferedImage bufferedImage = ImageIO.read(new BufferedInputStream(getClass().getClassLoader().getResourceAsStream("textures/notexture.png"))); 
