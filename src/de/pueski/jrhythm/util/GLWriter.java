...
public class GLWriter {
	...
	private static final Log log = LogFactory.getLog(GLWriter.class);
    ...
    private static GLWriter instance = null;
    
    protected GLWriter() {
    	buildFont();
    }
    
    public static GLWriter getInstance() {
    	if(instance == null) {
    		instance = new GLWriter();    		
    	}
    	return instance;
    }
...
//        try { 
//			ImageIO.write(fontImage, "PNG", new File("/home/mpue/Desktop/font.png"));
//		}
//		catch (IOException e) {
//			e.printStackTrace();
//		}
