...
@XmlRootElement
public class Filter2dScene extends AbstractScene {
	...
	public Filter2dScene() {
		super();
	}

	public Filter2dScene(String name) {
		super(name);
...
//		glEndList();
	...
	public void writeToXml(String location) throws Exception {
		Marshaller m = JAXBContext.newInstance(Filter2dScene.class, Box.class, Plane.class, Light.class).createMarshaller();
